...
KeywordUtil.logInfo("TC-OVT-36 > Sebagai User Aplikasi, saya tidak bisa melakukan pengajuan dengan melampirkan file jpeg dengan kapasitas lebih dari 2mb")
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'("overtime", "jpeg_upto2mb")