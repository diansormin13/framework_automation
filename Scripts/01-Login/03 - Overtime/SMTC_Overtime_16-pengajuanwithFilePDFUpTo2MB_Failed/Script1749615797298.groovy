...
KeywordUtil.logInfo("TC-OVT-34 > Sebagai User Aplikasi, saya tidak bisa melakukan pengajuan dengan melampirkan file pdf dengan kapasitas lebih dari 2mb")
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'("overtime", "upto2mb")