...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_E-Proc/button_notif'), 0)

WebUI.click(findTestObject('Object Repository/Page_E-Proc/button_notif'))

WebUI.click(findTestObject('Object Repository/Page_E-Proc/Search Pengadaan'))

WebUI.setText(findTestObject('Object Repository/Page_E-Proc/Input nama notif pengadaan'), 'PENGADAAN LANGSUNG PENGEMBANGAN BERKELANJUTAN APLIKASI MENGGUNAKAN RESOURCE EKSTERNAL LINGKUP DIREKTORAT UMUM & SDM')

WebUI.click(findTestObject('Object Repository/Page_E-Proc/button_Detil'))

WebUI.delay(20)

WebUI.click(findTestObject('Object Repository/Page_E-Proc/button_Logout'))
