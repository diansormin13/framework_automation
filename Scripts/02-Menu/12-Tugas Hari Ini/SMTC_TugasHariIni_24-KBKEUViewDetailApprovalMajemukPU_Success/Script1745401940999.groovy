...
KeywordUtil.logInfo('TC-TDL-025 - Sebagai role KBP Kantor Cabang utama, saya ingin melihat detail persetujuan TK Majemuk PU sesuai dengan section rolenya ')
...
screenshoot.takeScreenshot('beforDetailMajemukPU')
...
screenshoot.takeScreenshot('afterViewDetailMajemukPU')
