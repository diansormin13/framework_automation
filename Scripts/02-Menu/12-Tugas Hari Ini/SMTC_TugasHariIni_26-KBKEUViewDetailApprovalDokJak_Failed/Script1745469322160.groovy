...
KeywordUtil.logInfo('TC-TDL-027 - Sebagai role KBKEU Kantor Cabang utama, saya tidak bisa melihat detail approval ePLKK Tahap 1 pada salah satu section rolenya')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','beforeClickDetaileDokJakNegative')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','unableClickDetailDokJak')