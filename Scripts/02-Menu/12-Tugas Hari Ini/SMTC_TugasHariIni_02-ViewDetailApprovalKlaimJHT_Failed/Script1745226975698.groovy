...
KeywordUtil.logInfo('TC-TDL-003 - Sebagai user SMILE, saya tidak bisa mengakses detail approval jika role tidak sesuai dengan role yang dipilih user SMILE pada transaksi Klaim JHT dengan nilai selain 0 ')
