...
KeywordUtil.logInfo("TC-TDL-017 - Sebagai Role PMP, saya tidak bisa  melihat detail Approval pada salah satu approval Dokumen Jakon pada salah satu section role yang bernilai 0")
...
screenshoot.takeScreenshot('beforedetailApprovalePLKKTahap1NullValue')
...
screenshoot.takeScreenshot('UnabledetailApprovalePLKKTahap1NullValue')
