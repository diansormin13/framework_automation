...
KeywordUtil.logInfo('Sebagai Role PMP/KAKACAB, saya ingi melihat detail Approval pada salah satu approval ePLKK tahap 2 jika nilainya selain 0  sesuai dengan section rolenya ')
...
screenshoot.takeScreenshot('beforedetailApprovalePLKKTahap2')
...
screenshoot.takeScreenshot('SuccessdetailApprovalePLKKTahap2')
