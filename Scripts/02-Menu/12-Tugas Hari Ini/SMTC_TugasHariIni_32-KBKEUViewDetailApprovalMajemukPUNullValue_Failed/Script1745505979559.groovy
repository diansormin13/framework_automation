...
KeywordUtil.logInfo('TC-TDL-033 - Sebagai role KBP Kantor Cabang utama, saya tidak bisa melihat detail approval TK Majemuk PU pada salah satu section role KBP yang bernilai 0 ')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','beforeClickDetaileMajemukPUNullValue')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','unableClickDetailMajemukPUNullValue')