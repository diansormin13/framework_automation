...
KeywordUtil.logInfo("TC-TDL-019 - Sebagai Role PMP, saya tidak bisa  melihat detail Approval pada salah satu approval rujukan ePLKK pada salah satu section role yang bernilai 0")
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','beforeClickDetailRujukanePLKKNullValue')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','unableClickDetailRujukanePLKKNullValue')