...
KeywordUtil.logInfo('TC-TDL-032 - Sebagai role KBP Kantor Cabang utama, saya tidak bisa melihat detail approval TK Majemuk Jakon pada salah satu section role KBP yang bernilai 0 ')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','beforeClickDetaileMajemukJakonNullValue')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','unableClickDetailMajemukJakonNullValue')