...
KeywordUtil.logInfo('TC-TDL-024 - Sebagai role KBP Kantor Cabang utama, saya ingin melihat detail persetujuan Approval TK Majemuk Jakon sesuai dengan section rolenya ')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','beforDetailMajemukJakon')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('todolist','afterViewDetailMajemukJakon')
