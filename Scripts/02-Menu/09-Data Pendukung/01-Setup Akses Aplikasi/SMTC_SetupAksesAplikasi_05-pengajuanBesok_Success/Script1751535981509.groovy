...
KeywordUtil.logInfo('TC-OVT-54 > Sebagai Penata Operasional Cabang, saya ingin set tanggal pengajuan untuk hari ini hingga besok hari pada form pengajuan akses smile')
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('overtime/kolektif', 'isi_periode_pengajuan_hari_ini_dan_esok')