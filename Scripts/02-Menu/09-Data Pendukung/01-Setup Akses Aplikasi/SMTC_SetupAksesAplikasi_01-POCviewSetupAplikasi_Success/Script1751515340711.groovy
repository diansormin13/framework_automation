...
KeywordUtil.logInfo('TC-OVT-01 > Sebagai Penata Operasional Cabang, saya ingin mengakses menu Setup akses Aplikasi pada aplikasi SMILE')
...
akses.validatePageSetupAplikasi()

CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'('overtime/kolektif', 'view_SetupAkses_byPenataOpersionalCabang')
