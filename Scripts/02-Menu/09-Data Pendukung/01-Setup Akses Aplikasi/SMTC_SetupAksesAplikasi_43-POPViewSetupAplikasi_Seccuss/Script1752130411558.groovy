...
KeywordUtil.logInfo('TC-OVT-43 > Sebagai Penata Pengendalian Operasional, saya ingin mengakses menu Setup akses Aplikasi pada aplikasi SMILE')
...
WebUI.callTestCase(findTestCase('01-Login/02 - Login and Role/SMTC_Login_02-pilihRoleSSMILE_Success'), [('inisial') : findTestData(
            'SMDF_roleSMILE').getValue('inisial', 23), ('role') : findTestData('SMDF_roleSMILE').getValue('role', 23)], 
...
CustomKeywords.'sectionMenu.utilityMenu.takeScreenshot'("overtime/kolektif", "view_setupAkses_by_penata_pengendali_operasional")
